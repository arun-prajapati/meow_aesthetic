            ...
            <div className='w-full relative'>
                ...
                <div className='relative container flex flex-col justify-center gap-5 z-20 py-24 2xl:px-0 text-white'>
                    ...
                    <TypographyH1 className="font-medium font-plusjakartasans">
                        Book Your <span className='font-playfairdisplay italic'>Consultation</span>
                    </TypographyH1>
                    ...
                    <div className='grid lg:grid-cols-2 gap-16'>
                        ...
                        <form className='bg-[#FFFEFA30] border rounded-xl p-4 sm:p-7 lg:p-10 flex flex-col gap-5' onSubmit={handleSubmit(formSubmit)}>
                            <div className="grid grid-cols-2 w-full items-center gap-5">
                                <div className='flex flex-col'>
                                    ...
                                    <div className="flex flex-col w-full">
                                        <input type="text" id="firstname" placeholder="John" className='bg-transparent border-b outline-none py-3'
                                            {...register("first_name", {
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <div className='flex flex-col'>
                                        <input type="text" id="lastname" placeholder="Doe" className='bg-transparent border-b outline-none py-3'
                                            {...register("last_name", {
                            ...
                            <div className="grid grid-cols-2 w-full items-center gap-5">
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <div className="flex flex-col w-full">
                                        <input type="number" id="phone" placeholder="+9163531 10245" className='bg-transparent border-b outline-none py-3'
                        ...
                        <div className='flex flex-col gap-5 lg:px-10 lg:py-20'>
                            <TypographyH2 className='font-plusjakartasans'>
                                “Experience the best possible care at our aesthetic clinic.”
                            </TypographyH2>
                            <TypographyP className='text-[#FFFEFAC4]'>
                                Drop us a message below or make an appointment with our aesthetic doctor at +65 6235 7358 today.
                            </TypographyP>
